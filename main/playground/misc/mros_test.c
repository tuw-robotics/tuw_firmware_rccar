...
void timer_callback(rcl_timer_t *timer, int64_t last_call_time) {
    ...
    if (timer != NULL) {
        ...
        msg.data++;
        // ESP_LOGI("TIMER CALLBACK", "Publishing message...");
    }
}
...
void micro_ros_task(void *arg) {
    ...
    // create publisher
    RCCHECK(rclc_publisher_init_best_effort(&publisher, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Int32), "freertos_int32_publisher"));
