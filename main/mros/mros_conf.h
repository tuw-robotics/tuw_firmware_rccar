...
#ifdef CONFIG_MROS_IMU_LATENCY_TOPIC
#define MROS_IMU_LATENCY_TOPIC CONFIG_MROS_IMU_LATENCY_TOPIC
#else
#define MROS_IMU_LATENCY_TOPIC "imu_latency"
#endif

#ifdef CONFIG_MROS_IMU_LATENCY_PUBLISHER_PERIOD_MS
#define MROS_IMU_LATENCY_PUBLISHER_PERIOD_MS CONFIG_MROS_IMU_LATENCY_PUBLISHER_PERIOD_MS
#else
#define MROS_IMU_LATENCY_PUBLISHER_PERIOD_MS 100
#endif

#ifdef CONFIG_MROS_IMU_LATENCY_FRAME_ID
#define MROS_IMU_LATENCY_FRAME_ID CONFIG_MROS_IMU_LATENCY_FRAME_ID
#else
#define MROS_IMU_LATENCY_FRAME_ID "imu_latency"
#endif

#ifdef CONFIG_MROS_IMU_LATENCY_SOURCE
#define MROS_IMU_LATENCY_SOURCE CONFIG_MROS_IMU_LATENCY_SOURCE
#else
#define MROS_IMU_LATENCY_SOURCE "imu_latency"
#endif

#ifdef CONFIG_MROS_ODOM_LATENCY_TOPIC
#define MROS_ODOM_LATENCY_TOPIC CONFIG_MROS_ODOM_LATENCY_TOPIC
#else
#define MROS_ODOM_LATENCY_TOPIC "odom_latency"
#endif

#ifdef CONFIG_MROS_ODOM_LATENCY_PUBLISHER_PERIOD_MS
#define MROS_ODOM_LATENCY_PUBLISHER_PERIOD_MS CONFIG_MROS_ODOM_LATENCY_PUBLISHER_PERIOD_MS
#else
#define MROS_ODOM_LATENCY_PUBLISHER_PERIOD_MS 100
#endif

#ifdef CONFIG_MROS_ODOM_LATENCY_FRAME_ID
#define MROS_ODOM_LATENCY_FRAME_ID CONFIG_MROS_ODOM_LATENCY_FRAME_ID
#else
#define MROS_ODOM_LATENCY_FRAME_ID "odom_latency"
#endif

#ifdef CONFIG_MROS_ODOM_LATENCY_SOURCE
#define MROS_ODOM_LATENCY_SOURCE CONFIG_MROS_ODOM_LATENCY_SOURCE
#else
#define MROS_ODOM_LATENCY_SOURCE "odom_latency"
#endif
...
#else
#define MROS_CMD_VEL_TOPIC "cmd_vel_corr"
#endif
